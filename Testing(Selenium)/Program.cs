...
namespace Testing_Selenium_
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            IWebElement element1 = driver.FindElement(By.Id("1002"));
            ...
            Thread.Sleep(2000);
            IWebElement element2 = driver.FindElement(By.Name("Add"));
            ...
            IWebElement element3 = driver.FindElement(By.Name("back"));
